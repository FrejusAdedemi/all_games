 ...
 */
final class Version20260611165602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, release_date DATETIME NOT NULL, editor_id INT DEFAULT NULL, INDEX IDX_232B318C6995AC4C (editor_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, comment LONGTEXT DEFAULT NULL, review TINYINT NOT NULL, created_at DATETIME NOT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, INDEX IDX_794381C6A76ED395 (user_id), INDEX IDX_794381C6E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE wishlist_item (id INT AUTO_INCREMENT NOT NULL, create_at DATETIME NOT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, INDEX IDX_6424F4E8A76ED395 (user_id), INDEX IDX_6424F4E8E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
